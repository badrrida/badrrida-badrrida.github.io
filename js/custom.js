...
$(function() {
  ...
  if(bgndKenburns1.length){
    bgndKenburns1.vegas({
      ...
      slides: [
        { src: "img/backgrounds/1000x1200-bg-main-7.jpg" },
        { src: "img/backgrounds/1000x1200-bg-main-8.jpg" },
        { src: "img/backgrounds/1000x1200-bg-main-9.jpg" }
      ],
  ...
  if(bgndKenburns2.length){
    bgndKenburns2.vegas({
      ...
      transitionDuration: 2000,
      slides: [
        { src: "img/backgrounds/1000x1200-bg-main-11.jpg" },
        { src: "img/backgrounds/1000x1200-bg-main-12.jpg" },
        { src: "img/backgrounds/1000x1200-bg-main-13.jpg" }
      ],
      animation: [ 'kenburnsUp', 'kenburnsDown', 'kenburnsLeft', 'kenburnsRight' ]
    });
  };
  ...
  if(bgndKenburnsFull.length){
    bgndKenburnsFull.vegas({
      ...
      transitionDuration: 2000,
      slides: [
        { src: "img/backgrounds/1920x1080-bg-fullscreen-1.jpg" },
        { src: "img/backgrounds/1920x1080-bg-fullscreen-2.jpg" },
        { src: "img/backgrounds/1920x1080-bg-fullscreen-3.jpg" }
      ],
      animation: [ 'kenburnsUp', 'kenburnsDown', 'kenburnsLeft', 'kenburnsRight' ]
    });
  };
  ...
  // KBW-Countdown Start
  // --------------------------------------------- //
  $('#countdown').countdown({until: $.countdown.UTCDate(+4, 2022, 9, 1), format: 'D'});
  $('#countdown-large').countdown({until: $.countdown.UTCDate(+4, 2022, 9, 1), format: 'DHMS'});
  // --------------------------------------------- //
  // KBW-Countdown End
  // --------------------------------------------- //
